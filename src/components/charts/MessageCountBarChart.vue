...
import { transformMessageCountByUser } from '@/utils/chartTransforms'
...
const chartData = computed(() => {
  const { labels, data } = transformMessageCountByUser(chatStore.messageCountByUser)

  return {
    labels,
    datasets: [
      createDataset(data, 'Messages Sent', {
